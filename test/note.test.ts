...
describe('Test', () => {
    ...
    describe.only('Daemon', () => {
        it('Test it', async () => {
            ...
            const noteMetamorphicAddress =
                '0x45e35Be07d8C0A3c32c623f3d6903947ad5d7696';

            const daemonInitCode = daemonCode(
